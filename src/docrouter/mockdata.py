...
FIRST_NAMES = [
    "محمد", "عبدالله", "فهد", "سعود", "خالد", "نورة", "سارة", "منيرة",
    "عبدالرحمن", "تركي", "ريم", "هند", "بندر", "ماجد", "لطيفة", "أحمد",
]
FAMILY_NAMES = [
    "العتيبي", "القحطاني", "الغامدي", "الشهري", "الدوسري", "الحربي",
    "المطيري", "الزهراني", "السبيعي", "البقمي", "العنزي", "الشمري",
]
CITIES = [
    "الرياض", "جدة", "الدمام", "مكة المكرمة", "المدينة المنورة", "أبها",
    "تبوك", "بريدة", "حائل", "الخبر", "نجران", "جازان",
]
HIJRI_MONTHS = [
...
HARD_CASES: list[tuple[str, str, str]] = [
    ("moj_courts", "مطالبة بأجور بعد صدور حكم",
    ...
    ("hrsd_labor", "إصابة أثناء العمل ومطالبة بالأجر",
    ...
    ("civil_defense", "حريق في مبنى تحت الإنشاء",
    ...
    ("mci_commerce", "فاتورة غير نظامية من محل",
    ...
    ("interior_public_security", "بلاغ عن اعتداء قبل التحقيق",
    ...
    ("momah_municipal", "مطعم يصرف مخلفاته في الشارع",
...
def generate_templates(
    ...
    for i in range(n_hard):
        ...
        docs.append(
            Document(
                doc_id=f"hard-{i:03d}", text=text, source="mock", true_label=label
            )
        )
